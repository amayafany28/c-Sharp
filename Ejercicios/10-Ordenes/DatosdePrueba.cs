...
public class DatosdePrueba
{
    ...
    private void cargarProductos()
    {
        ...
        Producto p3 = new Producto(3, "MONITOR", 4500);
        ListadeProductos.Add(p3);

        Producto p4 = new Producto(4, "ESCANER", 385);
        ListadeProductos.Add(p4);

        Producto p5 = new Producto(5, "IMPRESORA CANNON", 3850);
        ListadeProductos.Add(p5);

        Producto p6 = new Producto(6, "PARLANTES", 600);
        ListadeProductos.Add(p6);
    }

    private void cargarClientes()
    {
        Cliente c1 = new Cliente(1, "Fany Karolina Amaya", "1615-1998-00149");
        ListadeClientes.Add(c1);

        Cliente c2 = new Cliente(2, "Nadya Lenina Nunez", "0501-1992-00017");
        ListadeClientes.Add(c2);

        Cliente c3 = new Cliente(3, "Wendy Pastora Ulloa", "0501-1993-01789");
        ListadeClientes.Add(c3);
    }

    private void cargarVendedores()
    {
        Vendedor v1 = new Vendedor(1, "Adeli Gavarrete", "V0001");
        ListadeVendedores.Add(v1);

        Vendedor v2 = new Vendedor(2, "Fabricio Guzman", "V0002");
